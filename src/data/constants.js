...
export const LISTINGS = [
  ...
  { id:15, name:'Danayit Café', nameAm:'ዳናይት ካፌ', cat:'Food & Drink', city:'Butajira', emoji:'☕', rating:0, reviews:0, badge:'new', tabs:['new'], phone:'+251984192223', desc:'Café service. Near Guzolma Building.' },
  ...
  { id:19, name:'Beki 12 Pictures', nameAm:'በኪ 12 ፒክቸርስ (በኪ 12 ፎቶ)', cat:'Photo & Video', city:'Butajira', emoji:'📸', rating:0, reviews:0, badge:'new', tabs:['new'], phone:'+251964090690', desc:'Photo studio — photos and video for weddings, birthdays, and other ceremonies. Near Guzolma Building.' },
