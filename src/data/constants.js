...
export const LISTINGS = [
  ...
  { id:15, name:'Danayit Café', nameAm:'ዳናይት ካፌ', cat:'Food & Drink', city:'Butajira', emoji:'☕', rating:0, reviews:0, badge:'new', tabs:['new'], phone:'+251977733741', phone2:'+251954043732', desc:'Café service. Near Guzolma Building.', photos:['danayit-cafe-1.jpg','danayit-cafe-2.jpg','danayit-cafe-3.jpg'] },
  ...
  { id:19, name:'Beki 12 Production', nameAm:'ቤኪ 12 ፕሮዳክሽን', cat:'Photo & Video', city:'Butajira', emoji:'📸', rating:0, reviews:0, badge:'new', tabs:['new'], phone:'+251964090690', desc:'Photo studio — photos and video for weddings, birthdays, and other ceremonies. Guzolma Building.', photos:['beki12-1.jpg','beki12-2.jpg'], lat:8.119941, lng:38.378808, placeId:'ChIJSWjGcwBBsxcRC75brMJgCfk', instagram:'https://www.instagram.com/beki12pictures' },
  ...
  { id:66, name:'AK Electronics', nameAm:'ኤኬ ኤሌክትሮኒክስ', cat:'Tech & IT', city:'Butajira', emoji:'💻', rating:0, reviews:0, badge:'new', tabs:['new'], phone:'+251911807591', desc:'Electronics and computer sales.' },
  { id:67, name:'Habesha Electronics', nameAm:'ሐበሻ ኤሌክትሮኒክስ', cat:'Tech & IT', city:'Butajira', emoji:'💻', rating:0, reviews:0, badge:'new', tabs:['new'], phone:'+251916200103', desc:'Electronics and computer sales.' },
  { id:68, name:'Zitu Electronics', nameAm:'ዚቱ ኤሌክትሮኒክስ', cat:'Tech & IT', city:'Butajira', emoji:'💻', rating:0, reviews:0, badge:'new', tabs:['new'], phone:'+251912122977', desc:'Electronics and computer sales.' },
  { id:69, name:'Tom General Trading', nameAm:'ቶም ጠቅላላ ንግድ', cat:'Wholesale & B2B', city:'Butajira', emoji:'📦', rating:0, reviews:0, badge:'new', tabs:['new'], phone:'+251916582620', desc:'General trading.' },
  { id:70, name:'Heyir General Trading', nameAm:'ሄይር ጠቅላላ ንግድ', cat:'Wholesale & B2B', city:'Butajira', emoji:'📦', rating:0, reviews:0, badge:'new', tabs:['new'], phone:'+251916691549', desc:'General trading.' },
  ...
  { id:74, name:'Muba Mobile Center', nameAm:'ሙባ ሞባይል ማዕከል', cat:'Tech & IT', city:'Butajira', emoji:'📱', rating:0, reviews:0, badge:'new', tabs:['new'], phone:'+251932680379', desc:'Mobile phone shop.' },
  { id:75, name:'Bushra Mobile Center', nameAm:'ቡሽራ ሞባይል ማዕከል', cat:'Tech & IT', city:'Butajira', emoji:'📱', rating:0, reviews:0, badge:'new', tabs:['new'], phone:'+251916762370', desc:'Mobile phone shop.' },
  { id:76, name:'Eza Mobile Center', nameAm:'እዛ ሞባይል ማዕከል', cat:'Tech & IT', city:'Butajira', emoji:'📱', rating:0, reviews:0, badge:'new', tabs:['new'], phone:'+251915599929', desc:'Mobile phone shop.' },
  { id:77, name:'MH Mobile Center', nameAm:'ኤምኤች ሞባይል ማዕከል', cat:'Tech & IT', city:'Butajira', emoji:'📱', rating:0, reviews:0, badge:'new', tabs:['new'], phone:'+251920762775', desc:'Mobile phone shop.' },
  ...
  { id:82, name:'Kidst Bete Wbet', nameAm:'ቅድስት የውበት ሳሎን', cat:'Beauty & Barber', city:'Butajira', emoji:'💇', rating:0, reviews:0, badge:'new', tabs:['new'], phone:'+251909487854', desc:'Beauty salon for women.' },
  { id:83, name:'Hafi Beauty Salon', nameAm:'ሀፊ የውበት ሳሎን', cat:'Beauty & Barber', city:'Butajira', emoji:'💇', rating:0, reviews:0, badge:'new', tabs:['new'], phone:'+251989916716', desc:'Beauty salon for women.' },
  { id:84, name:'Grace Shoes', nameAm:'ግሬስ ጫማ', cat:'Shoes & Bags', city:'Butajira', emoji:'👞', rating:0, reviews:0, badge:'new', tabs:['new'], phone:'+251916057835', desc:'Shoes and bags.' },
  { id:85, name:'Unique Bread', nameAm:'ዩኒክ ዳቦ ቤት', cat:'Grocery & Bakery', city:'Butajira', emoji:'🍞', rating:0, reviews:0, badge:'new', tabs:['new'], phone:'+251974378251', desc:'Bakery — bread.' },
  { id:86, name:'Sofi Super Market', nameAm:'ሶፊ ሱፐር ማርኬት', cat:'Grocery & Bakery', city:'Butajira', emoji:'🛒', rating:0, reviews:0, badge:'new', tabs:['new'], phone:'+251911806471', desc:'Mini market / grocery.' },
  { id:87, name:'Belay Mini Market', nameAm:'በላይ ሚኒ ማርኬት', cat:'Grocery & Bakery', city:'Butajira', emoji:'🛒', rating:0, reviews:0, badge:'new', tabs:['new'], phone:'+251919716495', desc:'Mini market / grocery.' },
  { id:88, name:'Abiti Bar and Restaurant', nameAm:'አቢቲ ባርና ሬስቶራንት', cat:'Food & Drink', city:'Butajira', emoji:'🍽', rating:0, reviews:0, badge:'new', tabs:['new'], phone:'+251911066641', desc:'Bar and restaurant.' },
  { id:89, name:'Family Construction Materials', nameAm:'ፋሚሊ የሕንፃ መሣሪያ', cat:'Construction', city:'Butajira', emoji:'🏗', rating:0, reviews:0, badge:'new', tabs:['new'], phone:'+251940023735', desc:'Construction materials.' },
  ...
  { id:91, name:'Amen Vegetables', nameAm:'አሜን አትክልትና ፍራፍሬ', cat:'Grocery & Bakery', city:'Butajira', emoji:'🥬', rating:0, reviews:0, badge:'new', tabs:['new'], phone:'+251912120349', desc:'Vegetables and fruits.' },
  { id:92, name:'Hani Super Market', nameAm:'ሀኒ ሱፐር ማርኬት', cat:'Grocery & Bakery', city:'Butajira', emoji:'🛒', rating:0, reviews:0, badge:'new', tabs:['new'], phone:'+251913932759', desc:'Mini market / grocery.' },
  ...
  { id:94, name:'Allah Wekil Boutique', nameAm:'አላህ ወኪል ቡቲክ', cat:'Fashion & Clothing', city:'Butajira', emoji:'👗', rating:0, reviews:0, badge:'new', tabs:['new'], phone:'+251969209266', desc:'Fashion clothing boutique.' },
  ...
  { id:97, name:'Beteseb Shoes', nameAm:'ቤተሰብ ጫማ', cat:'Shoes & Bags', city:'Butajira', emoji:'👞', rating:0, reviews:0, badge:'new', tabs:['new'], phone:'+251916759774', desc:'Shoes and bags.' },
  { id:98, name:'Abyssinia Fashion', nameAm:'አቢሲኒያ ፋሽን', cat:'Fashion & Clothing', city:'Butajira', emoji:'👗', rating:0, reviews:0, badge:'new', tabs:['new'], phone:'+251920977876', desc:'Fashion clothing.' },
  ...
  { id:100, name:'Grace Wears a Country Dress', nameAm:'ግሬስ የሀገር ባህል ልብስ', cat:'Fashion & Clothing', city:'Butajira', emoji:'👘', rating:0, reviews:0, badge:'new', tabs:['new'], phone:'+251921909832', desc:'Traditional and wedding clothing rental.' },
  { id:101, name:'Mubarak Boutique', nameAm:'ሙባረክ ቡቲክ', cat:'Fashion & Clothing', city:'Butajira', emoji:'👗', rating:0, reviews:0, badge:'new', tabs:['new'], phone:'+251913227744', desc:'Fashion clothing boutique.' },
  ...
  { id:103, name:'Habesha Silver Jewelry Store', nameAm:'ሐበሻ የብር ጌጣጌጥ', cat:'Fashion & Clothing', city:'Butajira', emoji:'💍', rating:0, reviews:0, badge:'new', tabs:['new'], phone:'+251910431991', desc:'Silver jewelry shop.' },
  { id:104, name:'Sime Fashion', nameAm:'ሲሜ ፋሽን', cat:'Fashion & Clothing', city:'Butajira', emoji:'👗', rating:0, reviews:0, badge:'new', tabs:['new'], phone:'+251911544028', desc:'Fashion clothing.' },
  { id:105, name:'Danayit Fashion', nameAm:'ዳናይት ፋሽን', cat:'Fashion & Clothing', city:'Butajira', emoji:'👗', rating:0, reviews:0, badge:'new', tabs:['new'], phone:'+251911540668', desc:'Fashion clothing.' },
  { id:106, name:'Hyber Style', nameAm:'ኅብር ስታይል', cat:'Fashion & Clothing', city:'Butajira', emoji:'👗', rating:0, reviews:0, badge:'new', tabs:['new'], phone:'+251942084728', desc:'Fashion clothing.' },
  { id:107, name:'Henok Bag Shop', nameAm:'ሄኖክ ቦርሳ ሱቅ', cat:'Shoes & Bags', city:'Butajira', emoji:'👜', rating:0, reviews:0, badge:'new', tabs:['new'], phone:'+251911540618', desc:'Bags shop.' },
  { id:108, name:'Ewnet Mulunesh Baltna', nameAm:'እውነት ሙሉነሽ ባልትና', cat:'Spices & Baltna', city:'Butajira', emoji:'🌶', rating:0, reviews:0, badge:'new', tabs:['new'], phone:'+251937163719', desc:'Traditional spices and condiments.' },
  { id:109, name:'Bereka Baltna', nameAm:'በረካ ባልትና', cat:'Spices & Baltna', city:'Butajira', emoji:'🌶', rating:0, reviews:0, badge:'new', tabs:['new'], phone:'+251912484993', desc:'Traditional spices and condiments.' },
  { id:110, name:'Sadi Baltna', nameAm:'ሳዲ ባልትና', cat:'Spices & Baltna', city:'Butajira', emoji:'🌶', rating:0, reviews:0, badge:'new', tabs:['new'], phone:'+251912213593', desc:'Traditional spices and condiments.' },
  { id:111, name:'Selam Baltna', nameAm:'ሰላም ባልትና', cat:'Spices & Baltna', city:'Butajira', emoji:'🌶', rating:0, reviews:0, badge:'new', tabs:['new'], phone:'+251911531983', desc:'Traditional spices and condiments.' },
  { id:112, name:'Merkato Baltna', nameAm:'መርካቶ ባልትና', cat:'Spices & Baltna', city:'Butajira', emoji:'🌶', rating:0, reviews:0, badge:'new', tabs:['new'], phone:'+251926986666', desc:'Traditional spices and condiments.' },
  ...
  { id:114, name:'Roman Baltna', nameAm:'ሮማን ባልትና', cat:'Spices & Baltna', city:'Butajira', emoji:'🌶', rating:0, reviews:0, badge:'new', tabs:['new'], phone:'+251920996327', desc:'Traditional spices and condiments.' },
  { id:115, name:'Harom Baltna', nameAm:'ሀሮም ባልትና', cat:'Spices & Baltna', city:'Butajira', emoji:'🌶', rating:0, reviews:0, badge:'new', tabs:['new'], phone:'+251926137148', desc:'Traditional spices and condiments.' },
  { id:116, name:'Feti Baltna', nameAm:'ፈቲ ባልትና', cat:'Spices & Baltna', city:'Butajira', emoji:'🌶', rating:0, reviews:0, badge:'new', tabs:['new'], phone:'+251912447959', desc:'Traditional spices and condiments.' },
